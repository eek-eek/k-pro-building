...
5. Проверяй группы требований к материалам: пожарная безопасность, механическая
   ...
   (сейсмомикрозонирование и выбор площадки, сейсмоизоляция; СП РК 2.03-30 и новые
   обязательные требования Строительного кодекса по снижению сейсмических рисков).
